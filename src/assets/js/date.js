...
(function ($) {
    $.fn.date = function (options, Ycallback, Ncallback) {
        ...
        var indexH = 1,
            indexI = 1,
            indexS = 0;
        var beginY = parseInt((options.beginyear + "").substr(2, 3));
        ...
        function bindButton() {
            ...
            $("#dateconfirm").unbind('click').click(function () {
                ...
                var myYear = $("#yearwrapper ul li:eq(" + indexY + ")").html().substr(0, $("#yearwrapper ul li:eq(" + indexY + ")").html().length - 1);
                var myMonth = $("#monthwrapper ul li:eq(" + indexM + ")").html().substr(0, $("#monthwrapper ul li:eq(" + indexM + ")").html().length - 1);
                var myDay = $("#daywrapper ul li:eq(" + Math.round(indexD) + ")").html().substr(0, $("#daywrapper ul li:eq(" + Math.round(indexD) + ")").html().length - 1);
                if (datetime) {
                ...
                if (Ycallback === undefined) {
                    ...
                    if (docType) {
                        that.eq(0).val(myYear);
                        that.eq(1).val(myMonth);
                        that.eq(2).val(myDay);
                        //that.val(datestr);页面时间更改
                    } else {
                        that.html(datestr);
                    }
                } else {
