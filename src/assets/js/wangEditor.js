...
_e(function (E, $) {
    ...
    //上传图片时图片大小的控制
    E.config.uploadImgMaxSize = 1 * 1024 * 1024
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $widthInput = $('<input type="text" value="320" style="width:50px;text-align:center;"/>');
        var $heightInput = $('<input type="text" value="249" style="width:50px;text-align:center;"/>');
