            ...
            for (var i = 0; i < 2; i++) {
              ...
              var divList = `<div class="author-kandan-friends-wrap">
                    ...
                    <div class="w40 text-right author-kandan-right">
                        <span class="author-before"><img class="lingxian" src="../../assets/images/chuju@3x.png" alt=""></span>
...
<template>
  <div id="AuctionIndex">
        ...
        <div id="carousel-bigimg-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner carousel-black" role="listbox">
            <div class="item active">
              <img class="img-responsive" id="banner001" src="../../assets/images/banner01.png" alt="">
            </div>
            <div class="item">
              <img id="banner002" src="../../assets/images/banner02.png" alt="">
            </div>
            <div class="item">
              <img id="banner003" src="../../assets/images/banner01.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="retail-goodsDetails pingdan-goodsDetails">
          ...
          <div class="banner" id="banner">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              <i class="icon_pingdan"><img class="img-responsive" src="../../assets/images/auction_logo.png" alt=""></i>
              <!-- Indicators -->
              <ol class="carousel-indicators comafter">
              ...
              <div class="carousel-inner carousel-banner" role="listbox">
                <div class="item active">
                  <img class="img-responsive" id="banner01" src="../../assets/images/banner01.png" alt="">
                </div>
                <div class="item">
                  <img id="banner02" src="../../assets/images/banner02.png" alt="">
                </div>
                <div class="item">
                  <img id="banner03" src="../../assets/images/banner01.png" alt="">
                </div>
              </div>
              <!--某人出价了-->
              <div class="js_Text_item auction-text-item" style="display: none">
                        <span class="js_text_item kandan-friends-item kandan-item-opacity">
                            <div class="flex-row">
                                <i class="kandan-friends-item-icon flex-row"><img class="img-responsive auction-price-header" src="../../assets/images/icon_message.png" alt=""></i>
              ...
              <!--<div class="auction-give-price-wrap">
                  <div></div>
                  <img class="auction-give-header" src="../../assets/images/auction_passfailt.png" alt="">
          ...
          <div class="auction-addprice-img-wrap">
            <!--当前价大于起拍价的秤砣图片-->
            <img style="display: none" class="auction_content_img" src="../../assets/images/auction_content_img.png">
            <!--改版后的当前价大于起拍价的秤砣图片-->
            <img style="display: none" class="auction_content_img" src="../../assets/images/auction_content_img_change.png">
            <!--改版后的当前价等于起拍价的秤砣图片-->
            <img style="display: block" class="auction_content_img" src="../../assets/images/auction_content_img_change1.png">
            <!--当前价等于起拍价的秤砣图片-->
            <img style="display: none" class="auction_content_img" src="../../assets/images/auction_content_img1.png">
            <!--起拍价格字样-->
            ...
            <!--图片定位-->
            <!--未到保留价-->
            <img style="display: none" class="auction-luo" id="auction-luo-underPrice" src="../../assets/images/auction-luo.png">
            <!--已过保留价-->
            <img style="display: block" class="auction-luo" id="auction-luo-passPrice" src="../../assets/images/auction-luo1.png">
          ...
          <div class="auction-result-change-wrap">
            <div class="auction-result-change">
              <img class="auction-result-border-img" src="../../assets/images/auction_result_change.png" alt="">
              <div class="auction-result-text">拍卖结果</div>
              <div class="auction-passfailt-img-wrap">
                <img style="display: none" class="auction-passfailt-img auction-passfailt-img-change" src="../../assets/images/auction_passfailt.png" >
                <div class="auction-passfailt-wrap" style="display: block">
                            <span id="auction-sbGet-img-id" style="position: relative">
                                <img class="auction-king" src="../../assets/images/auction_king.png">
                                <img class="auction-passfailt-img auction-passfailt-img-change" src="../../assets/images/auction_passfailt.png" >
                            </span>
                </div>
                <!--未达拍卖底价显示-->
                  ...
                  <div class="author-kandan-friends-wrap">
                    <div class="author-kandan-friends">
                                    <span class="author-touxiang">
                                        <img src="../../assets/images/author_touxiang.png">
                                    </span>
                      <span class="author-p-wrap">
                    ...
                    <div class="w40 text-right author-kandan-right">
                      <span class="author-before"><img class="lingxian" src="../../assets/images/lingxian@3x.png" alt=""></span>
          ...
          <!--商品简介-->
          <div><img class="img-responsive" src="../../assets/images/img_storeIntro_kandan.png" alt=""></div>
          ...
          <div class="retail-goodsDetails-stores-details">
            <a href="#">
              <img class="img-responsive" src="../../assets/images/retail-goodsDetails-img001.png" alt="">
              <span>门店<br>详情</span>
            </a>
          </div>
          <!--商品简介end-->
          ...
          <!--商品详情-->
          <img class="img-responsive" src="../../assets/images/retail-goodsDetails-icon03.png" alt="">
          <div class="retail-goodsDetails-show-detail">
            <img class="img-responsive" src="../../assets/images/retail-goodsDetails-img005.png" alt="">
          </div>
          <!--商品详情end-->
        </div>
      </div>
    ...
    <div class="auction-loading" style="display: none"><img  src="../../assets/images/loading.gif"></div>
    <!--这是遮罩层-->
    ...
    <div class="auction-give-moneySuccess-wrap" style="display:none;">
      <img style="display: block" class="auction-give-money-success" src="../../assets/images/auction_give_money_success.png" >
      ...
      <div class="comafter" style="position: relative;">
        <div class="col-xs-12">
          <div class="comafter retail-confirmBuying-style">
            <img class="auction_point1" style="width: 7px" src="../../assets/images/auction_point1.png">当前价：<span id="auctionNowPrice">600</span>
          </div>
          <div class="comafter retail-confirmBuying-num-buying">
            <div class="comafter">
              <div id="js_num_buying" class="col-xs-6 padding-0px text-left retail-confirmBuying-num-buying-left">
                <img class="auction_point1" style="width: 7px" src="../../assets/images/auction_point.png">加&nbsp;&nbsp;&nbsp;&nbsp;价：<span class="auctionAddPrice">200</span>
              </div>
      ...
      <div class="lqy-btnBuy-bottom auction-buttom auction-buttom-leftOdd">
        <div class="lqy-btnBuy-myAccount">
          <a href="#" class="a_block">
            <img class="lqy-btnBuy-myAccount-img" src="../../assets/images/auction_kefu.png" alt="">
            <div class="lqy-btnBuy-myAccount-text lqy-btnBuy-myAccount-text1">客服</div>
          </a>
        </div>
        <div class="lqy-btnBuy-myAccount">
          <a href="#" class="a_block">
            <img class="lqy-btnBuy-myAccount-img" src="../../assets/images/auction_shangcheng.png" alt="">
            <div class="lqy-btnBuy-myAccount-text lqy-btnBuy-myAccount-text1">商城</div>
          </a>
        </div>
        <div class="lqy-btnBuy-myAccount">
          <img class="lqy-btnBuy-myAccount-img" src="../../assets/images/auction_mine.png" alt="">
    ...
    <div class="wx-code-wrap" id="wxCode">
      ...
      公众号 <img class="wx-code" src="../../assets/images/wx_code.png" alt="">
    </div>
    <!--商家二维码弹出框-->
